...
The chroma-go client is tested against Chroma versions 0.6.3 to 1.5.5. When upgrading your Chroma server, check for any API changes that might affect your client code.

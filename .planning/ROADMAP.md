...
| 14. Delete with Limit | 0/2 | Planned | - |
...
Plans:
- [ ] 14-01-PLAN.md — Add Limit field to CollectionDeleteOp, ApplyToDelete to limitOption, validation, and embedded path wiring
- [ ] 14-02-PLAN.md — Add unit tests for option application, validation, and HTTP serialization

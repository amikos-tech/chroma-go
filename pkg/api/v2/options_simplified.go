...
// Note: The multiOption type is designed for future unified option handling.
// Currently, the apply methods are not used but will enable cross-operation
// option reuse once the collection operations are updated to support them.

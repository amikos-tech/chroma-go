...
func TestLocalClientOptions_InvalidInputs_TableDriven(t *testing.T) {
	tests := []struct {
		...
		{name: "library version slash", option: WithLocalLibraryVersion("v1/evil"), wantErr: "only ASCII letters"},
		{name: "library version backslash", option: WithLocalLibraryVersion("v1\\evil"), wantErr: "only ASCII letters"},
		{name: "library version parent path", option: WithLocalLibraryVersion("../evil"), wantErr: "only ASCII letters"},

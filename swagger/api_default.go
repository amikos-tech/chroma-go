...
func (a *DefaultApiService) AddExecute(r ApiAddRequest) (bool, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.Add")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/collections/{collection_id}/add"
	...
	if r.addEmbedding == nil {
		return localVarReturnValue, nil, reportError("addEmbedding is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.addEmbedding
...
func (a *DefaultApiService) CountExecute(r ApiCountRequest) (int32, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.Count")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/collections/{collection_id}/count"
	localVarPath = strings.Replace(localVarPath, "{"+"collection_id"+"}", url.PathEscape(parameterValueToString(r.collectionId, "collectionId")), -1)
...
func (a *DefaultApiService) CreateCollectionExecute(r ApiCreateCollectionRequest) (*Collection, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.CreateCollection")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiDeleteRequest) DeleteEmbedding(deleteEmbedding DeleteEmbedding) ApiDeleteRequest {
	r.deleteEmbedding = &deleteEmbedding
	return r
}
...
func (a *DefaultApiService) DeleteExecute(r ApiDeleteRequest) ([]string, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/collections/{collection_id}/delete"
	localVarPath = strings.Replace(localVarPath, "{"+"collection_id"+"}", url.PathEscape(parameterValueToString(r.collectionId, "collectionId")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.deleteEmbedding == nil {
		return localVarReturnValue, nil, reportError("deleteEmbedding is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.deleteEmbedding
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
func (a *DefaultApiService) DeleteCollectionExecute(r ApiDeleteCollectionRequest) (*Collection, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.DeleteCollection")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/collections/{collection_name}"
...
func (a *DefaultApiService) GetExecute(r ApiGetRequest) (*GetResult, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/collections/{collection_id}/get"
	localVarPath = strings.Replace(localVarPath, "{"+"collection_id"+"}", url.PathEscape(parameterValueToString(r.collectionId, "collectionId")), -1)
	...
	if r.getEmbedding == nil {
		return localVarReturnValue, nil, reportError("getEmbedding is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.getEmbedding
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
func (a *DefaultApiService) GetCollectionExecute(r ApiGetCollectionRequest) (*Collection, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.GetCollection")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiGetNearestNeighborsRequest) Execute() (*QueryResult, *http.Response, error) {
	return r.ApiService.GetNearestNeighborsExecute(r)
}
...
func (a *DefaultApiService) GetNearestNeighborsExecute(r ApiGetNearestNeighborsRequest) (*QueryResult, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.GetNearestNeighbors")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/collections/{collection_id}/query"
	localVarPath = strings.Replace(localVarPath, "{"+"collection_id"+"}", url.PathEscape(parameterValueToString(r.collectionId, "collectionId")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.queryEmbedding == nil {
		return localVarReturnValue, nil, reportError("queryEmbedding is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.queryEmbedding
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
func (a *DefaultApiService) HeartbeatExecute(r ApiHeartbeatRequest) (map[string]float32, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/heartbeat"
...
func (a *DefaultApiService) ListCollectionsExecute(r ApiListCollectionsRequest) ([]Collection, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.ListCollections")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *DefaultApiService) ResetExecute(r ApiResetRequest) (bool, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.Reset")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/reset"
...
func (r ApiUpdateRequest) UpdateEmbedding(updateEmbedding UpdateEmbedding) ApiUpdateRequest {
	r.updateEmbedding = &updateEmbedding
	return r
}
...
func (a *DefaultApiService) UpdateExecute(r ApiUpdateRequest) (bool, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/collections/{collection_id}/update"
	localVarPath = strings.Replace(localVarPath, "{"+"collection_id"+"}", url.PathEscape(parameterValueToString(r.collectionId, "collectionId")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.updateEmbedding == nil {
		return localVarReturnValue, nil, reportError("updateEmbedding is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.updateEmbedding
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
func (a *DefaultApiService) UpdateCollectionExecute(r ApiUpdateCollectionRequest) (*Collection, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.UpdateCollection")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/collections/{collection_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"collection_id"+"}", url.PathEscape(parameterValueToString(r.collectionId, "collectionId")), -1)
...
func (a *DefaultApiService) UpsertExecute(r ApiUpsertRequest) (bool, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.Upsert")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/collections/{collection_id}/upsert"
	localVarPath = strings.Replace(localVarPath, "{"+"collection_id"+"}", url.PathEscape(parameterValueToString(r.collectionId, "collectionId")), -1)
